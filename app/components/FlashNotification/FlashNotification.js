...
export default class FlashNotification extends Component{
  ...
  static propTypes={
    ...
    permenant: PropTypes.bool.isRequired,
  ...
  componentDidMount(){
    ...
    if(this.props.permenant === false ){
      setTimeout( ()=> {
        Animated.timing(this.state.opacity, {toValue:0, duration: 1000}).start(this.props.onHideNotification)
      }, this.props.length)
    }
